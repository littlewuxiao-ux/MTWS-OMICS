...
```python
>>> from avwx_custom.data import update_all
>>> update_all()
True
```
...
from avwx_custom.data.build_aircraft import main as update_aircraft
from avwx_custom.data.build_navaids import main as update_navaids
from avwx_custom.data.build_stations import main as update_stations
