...
# module
from avwx_custom import exceptions
from avwx_custom.base import AVWXBase
from avwx_custom.exceptions import MissingExtraModule
from avwx_custom.flight_path import to_coordinates
from avwx_custom.load_utils import LazyLoad
from avwx_custom.parsing import core
from avwx_custom.service.bulk import NoaaBulk, NoaaIntl, Service
from avwx_custom.static.airsigmet import BULLETIN_TYPES, INTENSITY, WEATHER_TYPES
from avwx_custom.static.core import CARDINAL_DEGREES, CARDINALS
...
class AirSigManager:
    ...
    >>> from avwx_custom.structs import Coord
