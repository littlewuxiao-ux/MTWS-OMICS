...
# module
from avwx_custom.current.base import Report, get_wx_codes
from avwx_custom.parsing import core, speech, summary
from avwx_custom.parsing.remarks import parse as parse_remarks
from avwx_custom.parsing.sanitization.taf import clean_taf_list, clean_taf_string
from avwx_custom.parsing.translate.taf import translate_taf
from avwx_custom.static.core import FLIGHT_RULES
from avwx_custom.static.taf import TAF_NEWLINE, TAF_NEWLINE_STARTSWITH, TAF_RMK
from avwx_custom.station import uses_na_format, valid_station
from avwx_custom.structs import (
    Cloud,
    Number,
    Sanitization,
    TafData,
...
def parse(
    ...
    if "CNL" in report:
        ...
        struct = TafData(
            ...
            station=station,
            time=core.make_timestamp(time, target_date=issued) if time else None,
            remarks="CNL",
            remarks_info=None,
