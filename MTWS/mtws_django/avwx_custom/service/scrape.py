...
from avwx_custom.exceptions import InvalidRequest

# module
from avwx_custom.parsing.core import dedupe
from avwx_custom.service.base import CallsHTTP, Service
from avwx_custom.station import Station, valid_station
...
def get_service(station: str, country_code: str) -> ScrapeService:
    ...
    station = "YWOL"
    country = "AU"  # can source from avwx_custom.Station.country
