...
# module
import avwx_custom.parsing.translate.base as translate_base
import avwx_custom.parsing.translate.taf as translate_taf
from avwx_custom.parsing import core
from avwx_custom.static.core import SPOKEN_UNITS

if TYPE_CHECKING:
    from avwx_custom.structs import Code, MetarData, Number, TafData, TafLineData, Timestamp, Units
