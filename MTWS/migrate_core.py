"""core 迁移确认工具：默认选中最新文件，确认后执行 migrate。"""
...
MIGRATIONS_DIR = DJANGO_DIR / "core" / "migrations"
APP_LABEL = "core"
...
class MigrateApp(tk.Tk):
    ...
    def _build(self):
        ...
        hint = tk.Label(
            self,
            text="默认选中 core/migrations 中编号最大的文件。弹窗设置/白名单属于 core，不是 parsers。",
            anchor="w",
            justify="left",
        )
